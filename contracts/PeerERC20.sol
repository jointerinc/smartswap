...
import './interfaces/IPeerERC20.sol';

contract PeerERC20 is IPeerERC20 {

    using SafeMath for uint;
    
    string public override constant name = 'Peer Liquadity Provider';
    string public override constant symbol = 'Peer';
